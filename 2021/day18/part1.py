...
# Tests
d = "[[[[[9,8],1],2],3],4]"
tree = create_node(d,0)
explode(tree)
print("Before: " + d)
print("After: " + visualise_tree(tree))
assert visualise_tree(tree) == "[[[[0,9],2],3],4]"
...
print("Before: " + d)
print("After: " + visualise_tree(tree))
assert visualise_tree(tree) == "[7,[6,[5,[7,0]]]]"
...
print("Before: " + d)
print("After: " + visualise_tree(tree))
assert visualise_tree(tree) == "[[6,[5,[7,0]]],3]"

d = "[[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]]"
tree = create_node(d,0)
explode(tree)
print("Before: " + d)
print("After: " + visualise_tree(tree))
assert visualise_tree(tree) == "[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]"
...
print("Before: " + d)
print("After: " + visualise_tree(tree))
assert visualise_tree(tree) == "[[3,[2,[8,0]]],[9,[5,[7,0]]]]"

d = "[[[[[4,3],4],4],[7,[[8,4],9]]],[1,1]]"
tree = create_node(d, 0)
print(visualise_tree(tree))
explode(tree)
print(visualise_tree(tree))
explode(tree)
print(visualise_tree(tree))
...
explode(tree)
print(visualise_tree(tree))
assert visualise_tree(tree) == "[[[[0,7],4],[[7,8],[6,0]]],[8,1]]"

with open("test3.txt") as f:
    d = f.readlines()
    d = [x.strip() for x in d]
    d = [create_node(x, 0) for x in d]
n = perform_reduction(d)
print(visualise_tree(n))
assert visualise_tree(n) == "[[[[1,1],[2,2]],[3,3]],[4,4]]"
...
n = perform_reduction(d)
print(visualise_tree(n))
assert visualise_tree(n) == "[[[[3,0],[5,3]],[4,4]],[5,5]]"
...
n = perform_reduction(d)
print(visualise_tree(n))
assert visualise_tree(n) == "[[[[5,0],[7,4]],[5,5]],[6,6]]"
...
n = perform_reduction(d)
print(visualise_tree(n))
assert visualise_tree(n) == "[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]"
...
n = perform_reduction(d)
print(visualise_tree(n))
assert visualise_tree(n) == "[[[[6,6],[7,6]],[[7,7],[7,0]]],[[[7,7],[7,7]],[[7,8],[9,9]]]]"

# Magnitude tests
d = "[9,1]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 29

d = "[1,9]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 21

d = "[[9,1],[1,9]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 129

d = "[[1,2],[[3,4],5]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 143

d = "[[[[0,7],4],[[7,8],[6,0]]],[8,1]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 1384

d = "[[[[1,1],[2,2]],[3,3]],[4,4]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 445

d = "[[[[3,0],[5,3]],[4,4]],[5,5]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 791

d = "[[[[5,0],[7,4]],[5,5]],[6,6]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 1137

d = "[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]"
tree = [create_node(d, 0)]
n = perform_reduction(tree)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 3488
...
n = perform_reduction(d)
print(calculate_magnitude(n))
assert calculate_magnitude(n) == 4140
